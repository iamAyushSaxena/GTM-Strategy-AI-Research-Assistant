...
for directory in [RAW_DATA_DIR, PROCESSED_DATA_DIR, SYNTHETIC_DATA_DIR, 
                  STRATEGY_DIR, FIGURES_DIR, REPORTS_DIR, DASHBOARDS_DIR]:
...
print(f"💰 Revenue Potential: ${MARKET_SIZE['som']['size'] * 15 * 0.10 / 1_000_000:.0f}M ARR at 10% conversion")