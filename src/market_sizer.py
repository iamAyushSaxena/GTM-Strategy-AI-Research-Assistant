...
class MarketSizer:
    ...
    def calculate_sam(self) -> Dict:
        ...
        self.sam_data = {
            ...
            'sources': [
                'Gartner AI Adoption Survey',
                'Statista SaaS Penetration Data'
            ]
        }
        ...
        print(f"   Validation (current AI users): {sam_alternative['current_ai_productivity_users']:,}")
    ...
    def calculate_som(self, timeframe_months: int = 12) -> Dict:
        ...
        """
        print(f"🚀 Calculating SOM (Serviceable Obtainable Market - {timeframe_months} months)...")
        ...
        som_final = int(activated * som_calculation['competitive_share']['our_share_percentage'])
        ...
        print(f"   Paying customers: {self.som_data['revenue_potential']['paying_customers']:,}")
    ...
    def generate_market_sizing_report(self) -> str:
        ...
        report += "-" * 80 + "\n"
        report += f"TAM (Total Addressable Market):     {self.tam_data['final']:>15,} users\n"
        ...
        report += f"   1. Potential Users:                    {potential:>10,} (100.0%)\n"
        ...
        activation_pct = self.som_data['calculation']['market_capture']['activation_rate']
        activated = int(signups * activation_pct)
        report += f"   4. Activated Users:                     {activated:>10,} ({activation_pct*100:>5.1f}% of signups)\n"
        
        share_pct = self.som_data['calculation']['competitive_share']['our_share_percentage']
        ...
        report += "multiple sources. SAM has reasonable filters. SOM depends heavily on\n"
...
if __name__ == "__main__":
    ...
    assumptions_df.to_csv(PROCESSED_DATA_DIR / 'market_sizing_assumptions.csv', index=False)
